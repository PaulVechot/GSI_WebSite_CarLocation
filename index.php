  ...
  <header>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url('image/accueil_slider/slide1.jpg')">
        ...
        <div class="carousel-item" style="background-image: url('image/accueil_slider/slide2.jpg')">
          <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item" style="background-image: url('image/accueil_slider/slide3.jpg')">
          <div class="carousel-caption d-none d-md-block">
            <h3>Large cible</h3>
    ...
    <div class="row">
      <div class="col-lg-4 col-sm-6 portfolio-item">
        <div class="card h-100">
          <a href="#"><img class="card-img-top" src="image/accueil_valeurs/satisfaction.svg" alt=""></a>
          <div class="card-body">
            <h4 class="card-title">
             Satisfaction client
            </h4>
      ...
      <div class="col-lg-4 col-sm-6 portfolio-item">
        <div class="card h-100">
          <a href="#"><img class="card-img-top" src="image/accueil_valeurs/partner.svg" alt=""></a>
          <div class="card-body">
            <h4 class="card-title">
             Responsabilité
            </h4>
      ...
      <div class="col-lg-4 col-sm-6 portfolio-item">
        <div class="card h-100">
          <a href="#"><img class="card-img-top" src="image/accueil_valeurs/value.svg" alt=""></a>
          <div class="card-body">
            <h4 class="card-title">
              Qualité
            </h4>
      ...
      <div class="col-lg-4 col-sm-6 portfolio-item">
        <div class="card h-100">
          <a href="#"><img class="card-img-top" src="image/accueil_valeurs/map.svg" alt=""></a>
          <div class="card-body">
            <h4 class="card-title">
              Proximité
            </h4>
      ...
      <div class="col-lg-4 col-sm-6 portfolio-item">
        <div class="card h-100">
          <a href="#"><img class="card-img-top" src="image/accueil_valeurs/respect.svg" alt="" ></a>
          <div class="card-body">
            <h4 class="card-title">
             Respect
            </h4>
      ...
      <div class="col-lg-4 col-sm-6 portfolio-item">
        <div class="card h-100">
          <a href="#"><img class="card-img-top" src="image/accueil_valeurs/solution.svg" alt=""></a>
          <div class="card-body">
            <h4 class="card-title">
             Integrité
            </h4>
